...
macro(_DO_GENERATE_EXPORT_HEADER TARGET_LIBRARY)
  ...
  set(EXPORT_FILE_NAME "${CMAKE_CURRENT_BINARY_DIR}/${BASE_NAME_LOWER}_exports/${BASE_NAME_LOWER}_export.h")
  set(EXPORT_FILE_NAME "${CMAKE_CURRENT_BINARY_DIR}/${BASE_NAME_LOWER}_exports/${BASE_NAME_LOWER}_export.h" PARENT_SCOPE)
  ...
  if(_GEH_EXPORT_FILE_NAME)
    if(IS_ABSOLUTE ${_GEH_EXPORT_FILE_NAME})
      ...
      set(EXPORT_FILE_NAME ${_GEH_EXPORT_FILE_NAME} PARENT_SCOPE)
    else()
      set(EXPORT_FILE_NAME "${CMAKE_CURRENT_BINARY_DIR}/${_GEH_EXPORT_FILE_NAME}")
      set(EXPORT_FILE_NAME "${CMAKE_CURRENT_BINARY_DIR}/${_GEH_EXPORT_FILE_NAME}" PARENT_SCOPE)
    endif()
  endif()
  get_filename_component (export_dir ${EXPORT_FILE_NAME} DIRECTORY)
  set(EXPORT_FILE_DIR "${export_dir}")
  set(EXPORT_FILE_DIR "${export_dir}" PARENT_SCOPE)
  ...
  set(EXPORT_IMPORT_CONDITION ${EXPORT_IMPORT_CONDITION} PARENT_SCOPE)
  ...
  configure_file("${_GEH_TEMPLATE_FILE}"
